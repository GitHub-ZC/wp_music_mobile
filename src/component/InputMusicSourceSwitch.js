...
class InputMusicSourceSwitch extends Component {
    constructor (props) {
        super(props);
    }
            ...
            <TouchableOpacity style={{                
                ...
                <Menu>
                    <MenuTrigger style={{width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center'}}>
                        <Text style={{fontSize: 16}}>{this.props.musicSource}</Text>
                    </MenuTrigger>
...
export default connect(mapStateToProps, mapDispatchToProps)(InputMusicSourceSwitch);